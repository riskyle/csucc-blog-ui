                ...
                <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    ...
                    <form onSubmit={handleSubmitNewBlog}>
                        ...
                        <button
                            ...
                            className={`inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white rounded-lg focus:ring-4 ${isSubmitting
                                ? 'bg-gray-400 cursor-not-allowed'
                                : 'bg-green-700 focus:ring-green-200 dark:focus:ring-green-900 hover:bg-green-800'
                                }`}
                        >
